  ...
  return (
    <main className="p-6 text-black">
      ...
      <section className="text-center py-12">
        ...
        <p className="text-xl text-gray-600">23. - 25. April 2026</p>
      </section>
      ...
      <section className="max-w-4xl mx-auto py-8">
        {/* Day 1 */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold mb-6 border-b pb-2">Fredag 23. april</h2>
          <div className="space-y-4">
            <div className="flex justify-between items-center py-3 border-b border-gray-200">
              <div>
                <p className="text-2xl font-bold">Dagny</p>
                <p className="text-gray-600">Hovedscenen</p>
              </div>
        ...
        {/* Day 2 */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold mb-6 border-b pb-2">Lørdag 24. april</h2>
          <div className="space-y-4">
            <div className="flex justify-between items-center py-3 border-b border-gray-200">
              <div>
        ...
        {/* Day 3 */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold mb-6 border-b pb-2">Søndag 25. april</h2>
          <div className="space-y-4">
            <div className="flex justify-between items-center py-3 border-b border-gray-200">
              <div>
      ...
      {/* Note */}
      <section className="max-w-4xl mx-auto text-center py-8 text-gray-500">
